...
urlpatterns = patterns('',
    ...
    (r'^cloud/get_chapters',get_chapters),
    (r'^cloud/get_examples',get_examples),
    (r'^cloud/get_code',get_code),
    (r'^logout/$',logout),
    ...
    (r'^cloud/graphs/(?P<path>.*)$', 'django.views.static.serve',{'document_root': settings.GRAPHS_ROOT}),
)
